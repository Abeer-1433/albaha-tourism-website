      ...
      <section className="section-padding bg-white">
        <div className="container-custom">
          <div className="text-center mb-12">
            ...
            <p className="text-2xl text-gray-600 max-w-3xl mx-auto">
              موقع قرية ذي عين التراثية في منطقة الباحة
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <div className="space-y-4 text-gray-700">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p>24 كم جنوب غرب مدينة الباحة</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="font-bold mb-1">الإحداثيات</p>
                    <p dir="ltr">19°55'48"N, 41°26'31"E</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p>1,985 متر فوق مستوى سطح البحر</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p>تتوفر مواقف للسيارات قرب مدخل القرية</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="relative h-96 rounded-xl overflow-hidden shadow-2xl">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3608.1234567890123!2d41.44194441500757!3d19.93000008702345!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x15ef4cd123456789%3A0xabcdef1234567890!2sThee%20Ain%20Heritage%20Village!5e0!3m2!1sen!2ssa!4v1234567890123!5m2!1sen!2ssa"
                width="600"
                height="450"
                style={{ border: "0" }}
                allowFullScreen
